...
BOOST_AUTO_TEST_CASE(change_fizz_divisor_and_buzz_divisor)
{
    // Fizz の除数として 4 を,
    // Buzz の除数として 6 を指定する
    FizzBuzz fizz_buzz = { Fizz { 4 }, Buzz { 6 } };
...
BOOST_AUTO_TEST_CASE(change_fizz_message_and_buzz_message)
{
    // Fizz の文言として "fizz++" を,
    // Buzz の文言として "buzz++" を指定する
    FizzBuzz fizz_buzz = { Fizz { "fizz++" }, Buzz { "buzz++" } };
...
BOOST_AUTO_TEST_CASE(change_all)
{
    ...
    // Fizz の文言として "fizz++" を,
    // Buzz の文言として "buzz++" を指定する
    FizzBuzz fizz_buzz = { Fizz { 4, "fizz++" }, Buzz { 6, "buzz++" } };
